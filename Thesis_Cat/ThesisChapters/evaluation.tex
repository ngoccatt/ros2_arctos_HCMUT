...
\section{Điều khiển Robot thông qua RC5}
...
\section{Hệ thống điều khiển với Ros2}
...
\subsection{Hệ thống điều khiển chính với Ros2-Control và MoveIt}
...
\subsection{Hệ thống điều khiển mô phỏng với Ros2-Control, MoveIt2 và Gazebo}
...
\subsection{Denso MoveIt-Servo Service provider}
...
\subsection{Denso Remote Control Action Server}
...
\subsection{Đánh giá về độ trễ Execution trên thiết bị thực tế}
...
\section{Ứng dụng VR điều khiển cánh tay robot}
...
\subsection{Đánh giá độ trễ truyền nhận thông qua Ros-Sharp giữa ứng dụng và Ros2}
...
\subsection{Đánh giá hiệu năng ứng dụng trong quá trình hoạt động}

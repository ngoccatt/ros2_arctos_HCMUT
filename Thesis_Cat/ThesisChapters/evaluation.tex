...
root@NaruKiri:~/ros2_ws# colcon build --symlink-install
\end{lstlisting}

Quá trình build sẽ diễn ra trong vài phút, và thực hiện build 10 module khác nhau như kết quả dưới:

\begin{lstlisting}[style=bashstyle]
(denso) root@NaruKiri:~/ros2_ws# colcon build --symlink-install
Starting >>> serial
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# source install/setup.bash
\end{lstlisting}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 launch denso_bringup denso_bringup.launch.py use_sim_time:=false
\end{lstlisting}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/bringup1.png}
        \caption{Giao diện điều khiển chính với Rviz}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/bringup2.png}
        \caption{Điều khiển các trục phần cánh tay}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/bringup3.png}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 launch denso_bringup gz_denso_bringup.launch.py use_sim_time:=true
\end{lstlisting}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/gz_bringup_1.png}
        \caption{Gazebo mô phỏng cánh tay robot}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/gz_bringup_2.png}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 launch denso_moveit_servo denso_moveit_servo.launch.py
\end{lstlisting}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 run denso_moveit_servo servo_keyboard_input
\end{lstlisting}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{Images/Implementation/denso_moveitservo.png}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 launch denso_remote_control remote_control.launch.py
\end{lstlisting}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/remote_control_1.png}
...
\begin{lstlisting}[style=bashstyle]
root@NaruKiri:~/ros2_ws# ros2 launch file_server2 ros_sharp_communication.launch.py
\end{lstlisting}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\linewidth]{Images/Implementation/rosbridge_server.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_connect.png}
        \caption{Trạng thái đã kết nối}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_disconnect.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Implementation/vr_camera.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Implementation/vr_moveit_servo.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_gripper_open.png}
        \caption{Tay gắp ở trạng thái đóng}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_gripper_close.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Implementation/vr_joint_rotate.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_grab_rotate.png}
        \caption{Giao diện Robot Grab Rotate}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Implementation/vr_grab_rotate_1.png}
...
Mục tiêu của ứng dụng là đảm bảo tính đồng bộ cao, thời gian thực đối với cánh tay robot thực tế, nên độ trễ truyền nhận giữa ứng dụng và máy PC chạy Ros là một tiêu chí cần kiểm tra. Đề tài thực hiện đo đạc trong quá trình sử dụng ứng dụng bình thường, tính thời gian RTT khi topic joint\_states được publish (tần số publish trùng với tần số của Ros2-control - 100ms), ứng dụng VR sẽ publish vào một topic ack khác, và từ phía Ros sẽ lấy thời gian cách biệt đó cho một vòng RTT. Kết quả đánh giá độ trễ như sau:

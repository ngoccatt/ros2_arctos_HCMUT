...
\subsection{Đánh giá các thành phần đã hiện thực}
...
\begin{itemize}
    ...
    Về hiệu năng, RTT trung bình giữa ứng dụng VR và Ros2 ở điều kiện mạng bình thường đạt \textbf{22{,}6\,ms} (P95 = 52{,}4\,ms, P99 = 80{,}0\,ms) -- đủ đáp ứng yêu cầu phản hồi thời gian thực cho điều khiển từ xa. Ứng dụng chạy ổn định ở trung bình \textbf{66{,}1\,fps} trong 30{,}8 phút kiểm thử, tuy nhiên CPU trung bình 76{,}3\% (đỉnh 93\%) cho thấy tải tính toán đang là nút cổ chai, đặc biệt khi xử lý đồng thời Ros-Sharp, IK cho chế độ Grab Rotate và render scene VR. Nhiệt độ pin đạt trung bình 45{,}8\,\textdegree{}C, vượt nhẹ ngưỡng khuyến nghị 45\,\textdegree{}C của Meta khi sử dụng liên tục trên 20 phút, song chưa kích hoạt throttling nhiệt.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Lưu và chạy lại chuỗi hành động}: Bổ sung tính năng lưu chuỗi thao tác điều khiển VR thành, cho phép người dùng lưu và phát lại các chuyển động lặp đi lặp lại, hướng tới ứng dụng lập trình robot bằng thao tác trực tiếp.

...
%------------------------------------------------------------
%   Make tblr table caption so that "Bang 3.1" in bold, no ":"
%------------------------------------------------------------
% 1. Make the label "Bảng 3.1" bold (Note the lowercase 'r' and correct bracket syntax)
\SetTblrStyle{caption-tag}{\bfseries}
% 2. Replace the default colon ":" separator with a space
...
\titlecontents{chapter}% <section-type>
  ...
  {\titlerule*[0.5pc]{.}\contentspage}% <filler-page-format with dots>

%   % Set section indent to 0pt
% \titlecontents{section}[1.0pt]
%   {}
%   {\thecontentslabel.\quad}
%   {}
%   {\titlerule*[0.5pc]{.}\contentspage}

% % Set subsection indent to 1.5em (smaller than default)
% \titlecontents{subsection}[2.0em]
%   {}
%   {\thecontentslabel.\quad}
%   {}
%   {\titlerule*[0.5pc]{.}\contentspage}

% % Set subsubsection indent to 3.0em
% \titlecontents{subsubsection}[3.0em]
%   {}
%   {\thecontentslabel.\quad}
%   {}
%   {\titlerule*[0.5pc]{.}\contentspage}
...
%------------------------------------------------------------
%   Bold Hinh/Bang at table
%------------------------------------------------------------
\makeatletter
\renewcommand*\l@figure[2]{%
  \ifnum \c@tocdepth >\z@
    \@dottedtocline{1}{0pt}{6em}{%
      \def\numberline##1{\hb@xt@\@tempdima{\textbf{Hình~##1}\hfil}}#1%
    }{#2}%
  \fi}
...
\renewcommand*\l@table[2]{%
  \ifnum \c@tocdepth >\z@
    \@dottedtocline{1}{0pt}{6em}{%
      \def\numberline##1{\hb@xt@\@tempdima{\textbf{Bảng~##1}\hfil}}#1%
    }{#2}%
  \fi}
\makeatother
...
\include{Others/ThesisCoverPage2}
\pagenumbering{roman}
\include{Others/mission}
...
% \include{Others/teacherConfirmation}
...
\include{ThesisChapters/research}
